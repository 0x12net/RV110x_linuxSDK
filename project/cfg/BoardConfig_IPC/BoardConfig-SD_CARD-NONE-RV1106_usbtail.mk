...
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rv1106_usbtail_defconfig

# Kernel dts
export RK_KERNEL_DTS=rv1106g-usbtail.dts

# buildroot defconfig
export RK_BUILDROOT_DEFCONFIG=rv1106_usbtail_defconfig
...
export RK_PRE_BUILD_OEM_SCRIPT=rv1106-cleaning-pre_oem.sh
